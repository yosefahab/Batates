...
fn main() {
    ...
    let layer_shell = app
        .layer_shell
        .clone()
        .expect("compositor did not advertise zwlr_layer_shell_v1; see platform/wayland/probe.rs");
    ...
    let (device, queue_gpu) = pollster::block_on(adapter.request_device(&wgpu::DeviceDescriptor {
